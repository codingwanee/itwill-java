...
public class IfExampleApp {
	public static void main(String[] args) {
		...
		//정수변수에 저장된 상수가 4의 배수인지 아닌지를 구분하여 출력하세요.
		int num=345644;
		if(num%4==0) {
		...
		*/
		...
		if(eng<0 || eng>100) {
			System.out.println("[에러]비정상적인 영어점수가 입력 되었습니다.");
			valid=true;
		}
		if(mat<0 || mat>100) {
			System.out.println("[에러]비정상적인 수학점수가 입력 되었습니다.");
			valid=true;
		}
		if(valid) {
			System.out.println("============================================");
