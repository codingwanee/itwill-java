...
//주민번호를 입력받아 생년월일,성별을 구분하여 출력하는 프로그램
// => 입력 주민번호는 14자리이며 7번 위치에는 - 문자가 존재(유효성 검사)
// => 비정상적인 주민번호를 입력한 경우 에러메세지 출력 후 재입력
//ex) 주민번호 입력[ex.900101-1234567] >> 901225-1234567
