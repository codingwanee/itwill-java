...
// => 객체 단위로 입출력 하기 위한 클래스는 반드시 객체직렬화(Object Serializable) 선언되어야 된다.
//객체직렬화 : 인스턴스를 Byte 배열 단위로 변환하여 전달하거나 전달받기 위한 기능을 제공하기 위한 방법
//객체직렬화 클래스를 선언하는 방법
//1)java.io.Serializable 인터페이스를 상속받아 작성
// => 클래스의 모든 필드값을 Byte 배열로 변환하는 기능 제공
//2)java.io.Externalizable 인터페이스를 상속받아 작성
// => 클래스의 원하는 필드값을 Byte 배열로 변환하는 기능 제공
